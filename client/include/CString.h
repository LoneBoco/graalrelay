...
class CString
{
	public:
		...
		CString bzcompress(unsigned int buffSize = 0x400000) const;
		CString bzuncompress(unsigned int buffSize = 0x400000) const;
		CString zcompress(unsigned int buffSize = 0x400000) const;
		CString zuncompress(unsigned int buffSize = 0x400000) const;
